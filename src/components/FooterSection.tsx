...
import { MessageCircle, Shield, FileText, Phone, Mail, MapPin, Instagram } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-secondary-foreground/80 mb-6 leading-relaxed">
                A plataforma completa para gerenciar seu WhatsApp Business com inteligência artificial e automação.
              </p>
              <div className="flex space-x-4">
                <div 
                  ...
                  onClick={() => openWhatsApp(ZAPLIA_WHATSAPP, "Olá! Quero saber mais sobre o Zaplia!")}
                >
                  <MessageCircle className="w-5 h-5" />
                </div>
                <div 
                  className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors cursor-pointer"
                  onClick={() => openWhatsApp(ZAPLIA_WHATSAPP, "Gostaria de entrar em contato por email!")}
                >
                  <Mail className="w-5 h-5" />
                </div>
                <div 
                  className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors cursor-pointer"
                  onClick={() => openWhatsApp(ZAPLIA_WHATSAPP, "Gostaria de falar por telefone!")}
                >
                  <Phone className="w-5 h-5" />
                </div>
                <div 
                  className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors cursor-pointer"
                  onClick={() => window.open('https://instagram.com/zaplia_oficial', '_blank')}
                >
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div 
                  ...
                  onClick={() => openWhatsApp(ZAPLIA_WHATSAPP, "Gostaria de saber mais sobre a localização!")}
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-6 mb-4 md:mb-0">
              <div className="flex items-center">
                ...
                <span className="text-secondary-foreground/80 text-sm">LGPD Compliance</span>
              </div>
              <div className="flex items-center">
                <FileText className="w-5 h-5 text-primary mr-2" />
                <span className="text-secondary-foreground/80 text-sm">Segurança Garantida</span>
              </div>
            </div>
